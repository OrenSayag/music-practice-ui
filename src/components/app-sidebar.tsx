    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <Link
          to="/settings"
          className={cn(
            'flex items-center gap-3 rounded-sm px-3 py-2 text-sm text-muted-foreground hover:text-foreground',
        ...
        <button
          ...
          className="flex items-center gap-3 rounded-sm px-3 py-2 text-sm text-muted-foreground hover:text-foreground"
        >

  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="flex shrink-0 items-start gap-3 border-t border-border p-4">
        <Textarea
          className="max-h-32 min-h-10 flex-1 resize-none font-mono text-base placeholder:text-muted-foreground/60"
...
function ThinkingIndicator() {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <p className="animate-pulse font-mono text-base text-muted-foreground">...</p>
    </div>
  );
}

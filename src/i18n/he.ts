...
export const he: Record<TranslationKey, string> = {
  ...
  'settings.teacher': 'מורה',
  'settings.teacherDescription': 'הגדר כדי לאפשר שיתוף סיכומי תרגול בוואטסאפ.',
  'settings.teacherName': 'שם המורה',
  'settings.teacherPhone': 'טלפון המורה',
  'settings.teacherPhonePlaceholder': '+972500000000',
  'settings.teacherLanguage': 'שפת ההודעה',
  'settings.removeTeacher': 'הסר מורה',
  'share.toTeacher': 'שתף עם המורה',
  'share.noTeacherTooltip': 'הגדר מורה בהגדרות כדי לשתף',
  'share.message.greeting': 'היי {{name}}, הנה סיכום התרגול שלי:',
  'share.message.session': 'מפגש: {{name}}',
  'share.message.totalTime': 'זמן כולל: {{time}}',
  'share.message.weekTotal': 'השבוע עד כה: {{time}}',
  'share.message.itemsHeader': 'פריטים:',
  'share.message.itemLine': '{{idx}}. {{name}} — {{status}} ({{duration}}{{bpm}})',
  'share.message.bpmSuffix': ' @ {{bpm}} bpm',
  'share.message.notes': 'הערות: {{notes}}',
